...
def compare_multiclass_with_baselines(
    ...
    参数:
        ...
        n_classes: 类别数量
        random_state: 随机种子
        baseline_params_override: 基线模型参数覆盖
    ...
    # 基线模型参数
    baselines_config = {
        'LogisticRegression': {'multi_class': 'multinomial', 'random_state': random_state, 'max_iter': 200},
        'RandomForest': {'random_state': random_state, 'n_estimators': 100},
        'SVM': {'probability': True, 'decision_function_shape': 'ovr', 'random_state': random_state},
        'MLP': {'random_state': random_state, 'max_iter': 500}
    }
    ...
    mlp_metrics = evaluate_multiclass_classification(y_test, y_pred, y_pred_proba)
